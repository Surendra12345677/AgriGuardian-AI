    ...
    <html lang="en">
      <body>
        ...
        <footer className="border-t border-white/5 mt-20 bg-[#04060a]">
          <div className="mx-auto w-full max-w-[1760px] 2xl:max-w-[2100px] 3xl:max-w-[2560px] px-5 lg:px-8 xl:px-12 2xl:px-16 py-10 grid md:grid-cols-4 gap-8 text-sm">
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-slate-400">
                <li><a className="hover:text-emerald-300" href="#onboard">Onboard a farm</a></li>
                <li><a className="hover:text-emerald-300" href="#plan">Plan a season</a></li>
          ...
          <div className="border-t border-white/5">
            <div className="mx-auto max-w-[1760px] 2xl:max-w-[2100px] 3xl:max-w-[2560px] px-5 lg:px-8 xl:px-12 2xl:px-16 py-4 flex flex-wrap items-center justify-between gap-2 text-xs text-slate-500">
